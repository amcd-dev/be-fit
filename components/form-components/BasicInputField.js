...
export default function BasicInputField(props) {
    return (
        <div className="relative mt-5 mx-2 rounded-md border border-gray-300 px-3 py-1 shadow-sm focus-within:border-indigo-600 focus-within:ring-1 focus-within:ring-indigo-600">
